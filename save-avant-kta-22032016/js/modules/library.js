...
(function($) {
    ...
    $.cxpLibrary = function(el, options) {
        ...
        var registerEvents = function() {
            ...
            $element.on('click.library', '.lb-select-list-link', plugin.itemPreview);
            $element.on('click.library', '.lb-js-btn', plugin.regenModalAction);
            ...
            $element.find('.cxp-pagination').on('pagechange', function() {
                updateItemsInfos();
            });
